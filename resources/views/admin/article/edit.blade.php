      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('admin/articles/'.$article->id) }}" enctype="multipart/form-data" method="POST">
            ...
            Articles title：<input type="text" name="title" class="form-control" required="required" value="{{ $article->title }}">
            <br>
     Articles types:
            ...
            <br>
             <br>
     articles content：<textarea name="body" rows="10" class="form-control" required="required">{{ $article->body }}</textarea>
            <br>
